...
public interface MUDServerInterface extends Remote {
    ...
    String showLocationPlayers(String MUDName, String location) throws RemoteException;
    String showLocationItems(String MUDName, String location) throws RemoteException;
